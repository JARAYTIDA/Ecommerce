    ...
    if(email === undefined || email === null){
      ...
      try {
        // console.log(productCounter);
          const response = await fetch(`https://ecommerce-295o.onrender.com/auth/add-to-cart?email=${email}&id=${id}&product=${product}&count=${productCounter}&price=${products_data[product][id-1].price1}&img=${products_data[product][id-1].img}&name=${products_data[product][id-1].name}`);
          if (response.ok) {
