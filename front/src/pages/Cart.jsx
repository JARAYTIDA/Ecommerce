...
const Cart = () => {
    ...
    const getPrice = async (email_id) => {
        try {
            const response = await fetch(`https://ecommerce-lcv2.onrender.com/auth/total?email=${email_id}`);
    ...
    const getData = async (email_id) => {
        ...
        try {
            const response = await fetch(`https://ecommerce-lcv2.onrender.com/auth/get-cart?email=${email_id}`);
            // console.log(response);
            if (response.ok) {
                const data = await response.json();
                // console.log(data);
	...
	const makePayment = async()=>{
        ...
        const response = await fetch(`https://ecommerce-lcv2.onrender.com/auth/pay?email=${email}`,{
            method:"POST",
            headers:headers,
    ...
    const incrCart = async (product, id) => {
        ...
        const response = await fetch(`https://ecommerce-lcv2.onrender.com/auth/incr-cart?product=${product}&id=${id}&email=${email}`)
        try {
            if (response.ok) {
                const data = await response.json();
                // console.log(data); // Response from the server
    ...
    const decCart = async (product, id) => {
        console.log('inc cart')
        const response = await fetch(`https://ecommerce-lcv2.onrender.com/auth/dec-cart?product=${product}&id=${id}&email=${email}`)
        try {
            if (response.ok) {
                const data = await response.json();
                // console.log(data); // Response from the server
    ...
    const remove = async (product, id) => {
        ...
        const response = await fetch(`https://ecommerce-lcv2.onrender.com/auth/remove?product=${product}&id=${id}&email=${email}`)
        try {
            if (response.ok) {
                const data = await response.json();
